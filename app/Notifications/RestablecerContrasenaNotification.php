...
class RestablecerContrasenaNotification extends Notification
{
  ...
  public function toMail($notifiable)
  {
      return (new MailMessage)
          ->from('softwareelectoralcrd@gmail.com', 'Restablecimiento Contraseña')
          ->subject('Solicitud de restablecimiento de contraseña')
          ->greeting('Hola '.$notifiable->name.' '.$notifiable->name2.' '.$notifiable->lastname.' '.$notifiable->lastname2)
