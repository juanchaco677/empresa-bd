<div class="container-fluid">
	<div class="row">
      ...
      <button type="submit" onclick="mostrarSeccionMenu('I','{{$urllistar.'/'.'create'}}','')" class="btn btn-primary">
		...
		<div class="col-md-2">
      <input id="nombreempresa" onkeyup="buscarEnTabla(this,'{{$urllistar.'/refrescar'}}','grilla-tabla')" type="text"    placeholder="Buscar por dirección" class="form-control" name="buscarentabla"  value="" >
		</div>
		<div class="col-md-2">
